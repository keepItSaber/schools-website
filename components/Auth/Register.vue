...
<section>
  <div class="flex min-h-screen overflow-hidden">
              ...
              <button type="submit" @click="register" class="w-full items-center block px-10 py-3.5 text-base font-medium text-center text-orange-400 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                <div class="flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="w-6 h-6" viewBox="0 0 48 48">
                    ...
                    <path clip-path="url(#b)" fill="#FBBC05" d="M0 37V11l17 13z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#fbc31e;"></path>
                    <path clip-path="url(#b)" fill="#EA4335" d="M0 11l17 13 7-6.1L48 14V0H0z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#eb5043;"></path>
                    <path clip-path="url(#b)" fill="#34A853" d="M0 37l30-23 7.9 1L48 0v48H0z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#62cf7f;"></path>
                    <path clip-path="url(#b)" fill="#4285F4" d="M48 48L17 24l-4-3 35-10z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#4ba0f4;"></path>
                  </svg>
    ...
    <div class="relative flex-1 hidden w-0 overflow-hidden lg:block">
      <img class="absolute inset-0 object-cover w-full h-full" src="~~/assets/images/auth_bg.jpg" alt="">
    </div>
  </div>
</section>
</template>